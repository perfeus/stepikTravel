...
depart = {1: {"departure": "Из Москвы",
          ...
          2: {"departure": "Из Петербурга",
              "cut": "spb",
              "link": "/spb/"},
          3: {"departure": "Из Новосибирска",
              "cut": "nsk",
              "link": "/nsk/"},
          4: {"departure": "Из Екатеринбурга",
              "cut": "ekb",
              "link": "/ekb/"},
          5: {"departure": "Из Казани",
              "cut": "kazan",
              "link": "/kazan/"}
          }
...
def mskTours():
    ...
    return render_template("index.html", depart=depart, tours=tours)


@app.route("/spb/")
def spbTours():
    return render_template("spb.html", depart=depart, tours=tours)


@app.route("/nsk/")
def nskTours():
    return render_template("nsk.html", depart=depart, tours=tours)


@app.route("/ekb/")
def ekbTours():
    return render_template("ekb.html", depart=depart, tours=tours)


@app.route("/kazan/")
def kazanTours():
    return render_template("kazan.html", depart=depart, tours=tours)
